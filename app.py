...
import os
import sys
sys.path.append(os.path.dirname(os.path.abspath(__file__))) # Add the app directory to sys.path
...
#new main.py codefrom app.app import ChatApp
from .utils.save_docs import save_docs_to_vectordb

def main():
    # put your existing logic here
    print("Starting RAG ChatBot...")
    save_docs_to_vectordb()
    # whatever else your app.py currently does
